...
//const int Kgraph::Component(const Vertex& source) {
//  return 0;
//}
...
int main() {
  ...
  Piece source_pennant[NUM_CELLS] = {KING, KING, DHOR, DHOR,
				     KING, KING, DHOR, DHOR,
				     SINGLETON, SINGLETON, BLANK, BLANK,
				     DVER, DVER, DHOR, DHOR,
				     DVER, DVER, DHOR, DHOR};

  G.ComputeShortestPaths(Vertex(source_pennant));

  return 0;
}

// TODOS:
//   1. Find configuration farthest from destination
